...
public class Exam04_5 {
  public static void main(String[] args) {
    ...
    //8비트에서 각 언ㄷ어야 값을 저장할 비트를 다음과 같다고 가정하자
    //00000000
    ...
    //||-c++
    //|-c
    //이렇게 준비 된 32비트 메모리에서 특정 비트의 값을 1로 설정하고 싶다면 
    //다음과 같이 특정 비트의 값이 1인 수를    OR(|)연산 하라
    lang2 |= 0x80; // c = true 
    ...
    // 실무에서는 이렇게 비트를 이용하여 여러 개의 true/false상태를 저장하기도 한다.
