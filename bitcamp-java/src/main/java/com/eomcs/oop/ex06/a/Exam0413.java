...
public class Exam0413 {
    ...
    public static void main(String[] args) {
        ...
        //Sedan의 모델명과 cc를 출력하는 메서드와
        //Truck의 모델명과 cc를 출력하는 메서드를 모두 만들어야하는 번거로움이 있다.
        //해결책?
        //Sedan과 Truck의 모델명과 메서드를 모두 출력하라
        //다형적 변수를 사용하게되면 동일한 코드를 갖고있는 메서드를 한개의 메서드로 통합 할 수 있다.
        //=>즉 Sedan객체와 Truck객체를 모두 가리킬 수 있는 상위클래스의 레퍼런스를 선언하면 된다.
