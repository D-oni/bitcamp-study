...
public class Exam0110 extends Object{
  //수퍼클래스를 지정하지 않으면 기본으로 java.lang.Object클래스가 수퍼클래스로 지정된다.
  ...
  public static void main(String[] args) {
    ...
    //toString()?
    //=>Score클래스의 수퍼클래스인 Object의 메서드이다.
    //=>클래스를 정의할 때 수퍼클래스를 지정하지않으면
    //  자동으로 java.lang.Onject클래스가 수퍼 클래스로 지정된다.
    //=>그래서 자바의 모든 클래스는 toString()을 호출할 수 있다.
    //  즉 자바의 모든 클래스는 Object클래스에 정의된 메서드를 호출 할 수 있다.
