...
public class BoardHandler {
  ...
  Board[] boards;
  int boardCount = 0;
  //이전까지 게시물 데이터를 입력받을 때 키보드로부터 입력 받았지만,
  //향후 네트워크나 파일 로부터도 입력받을 수 있다.
  //이런 경우를 대비하여 입력 데이터를 읽는 것을 keyBoard로 한정하지 말자
  //게시판마다 입력받는 방식이 다르게 할 수 있도록 인스턴스 변수로 선언하자!
   Scanner input;
